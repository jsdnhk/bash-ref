...
# auth:kaliarch
# version:v1.0
# func:elasticsearch 5.4.1/6.0.1/6.3.1安裝
# 定義安裝目錄、及日誌信息
...
echo "##########################################"
echo "#                                        #"
echo "# 安裝 elasticsearch 5.4.1/6.0.1/6.3.1   #"
echo "#                                        #"
echo "##########################################"
...
config_limits
config_jvm
echo "請使用一下命令啓動服務:'su - elasticsearch -c 'nohup /usr/local/elasticsearch/bin/elasticsearch &'"
